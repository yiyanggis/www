...
function nectar_typography() { 
	...
	<?php echo 'body, .toggle h3 a, .bar_graph li span strong, #search-results .result .title span, .woocommerce ul.products li.product h3, .woocommerce-page ul.products li.product h3
	{'; ?>
	...
	<?php echo 'header#top nav > ul > li > a, #header-secondary-outer nav > ul > li > a
	{'; ?>	
	...
	<?php echo 'header#top .sf-menu li ul li a, #header-secondary-outer ul ul li a
	{';?>	
	...
	<?php echo '#featured article .post-title h2 span, blockquote
	{'; ?>	
	...
	<?php echo '.team-member h3, .row .col.section-title p, .row .col.section-title span, #page-header-bg .subheader
	{'; ?>	
