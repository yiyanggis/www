...
function setup_framework_options(){
	...
	$sections[] = array(
        ...
        'fields' => array( 
			...
			array(
                ...
                'type' => 'select', 
                'title' => __('Home Slider Caption & Testinomial', NECTAR_THEME_NAME),
                'desc' => '',
                'options' => $typography_mixed_fonts
			),
	...
	$sections[] = array(
        ...
        'fields' => array( 
			...
			array(
                'id' => 'portfolio_extra_content', 
                'type' => 'checkbox_hide_below',
                'title' => __('Extra Content Editor', NECTAR_THEME_NAME),
                'sub_desc' => __('This will place another editor inside your portfolio items that will allow you to add anything you desire below the item. e.g. Stacked images, text, video embeds etc.', NECTAR_THEME_NAME),
                'desc' => '',
                'switch' => true,
                'std' => '0' 
			), 
			array(
                ...
                'sub_desc' => __('When supplying extra content, the page can get quite tall and feel empty on the right side. Enable this option to have your sidebar follow you down the page.', NECTAR_THEME_NAME),
                'desc' => '',
                'switch' => true,
                'std' => '0' 
			), 
