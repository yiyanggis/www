			...
			<div class="container">	
				<div class="row">
					...
					<div id="portfolio-filters">
						<a href="#" data-sortable-label="<?php echo (!empty($options['portfolio-sortable-text'])) ? $options['portfolio-sortable-text'] :'Sort Portfolio'; ?>" id="sort-portfolio"><span><?php echo (!empty($options['portfolio-sortable-text'])) ? $options['portfolio-sortable-text'] :'Sort Portfolio'; ?></span> <i class="icon-th"></i></a>
						<ul>
		...
		<div id="single-meta" data-sharing="<?php echo ( !empty($options['woo_social']) && $options['woo_social'] == 1 ) ? '1' : '0'; ?>">
			...
			if( !empty($options['woo_social']) && $options['woo_social'] == 1 ) {
				...
				if(!empty($options['woo-facebook-sharing']) && $options['woo-facebook-sharing'] == 1) {
					echo '<li class="facebook-share woo"><a href="#" title="Share this"><span class="count"></span></a></li>';
				}
				//twitter
				if(!empty($options['woo-twitter-sharing']) && $options['woo-twitter-sharing'] == 1) {
					echo '<li class="twitter-share woo"><a href="#" title="Tweet this"><span class="count"></span></a></li>';
				}
				//pinterest
				if(!empty($options['woo-pinterest-sharing']) && $options['woo-pinterest-sharing'] == 1) {
					echo '<li class="pinterest-share woo"><a href="#" title="Pin this"><span class="count"></span></a></li>';
				}
				echo '</ul>';	
			}
