							...
							<div id="CX_cnv_0">
								...
								<div id="CX_cnv_top" class="cx-cnv" style="display: none;">
									...
									<div class="cx-cnv-line">
										<div class="cx-cnv-time">13:02</div>
												
										<img src="<?php echo CX_URL; ?>/assets/img/default-avatar.png" alt="" class="cx-avatar cx-company-avatar">
												
										<div class="cx-cnv-msg">
											<div class="cx-cnv-author">screets:</div>
											<div class="cx-cnv-msg-detail">Yes. The OS X operation system isn't susceptible to the thousands of viruses plaguing Windows-based computers</div>
										</div>
									</div>
									<div class="cx-clear"></div>
									
									<div class="cx-cnv-line">
										<div class="cx-cnv-time">13:01</div>
												
										<img src="<?php echo CX_URL; ?>/assets/img/default-avatar.png" alt="" class="cx-avatar">
										
										<div class="cx-cnv-msg">
											<div class="cx-cnv-author">fatih:</div>
											<div class="cx-cnv-msg-detail">I wonder that a Mac is safe from PC viruses?</div>
