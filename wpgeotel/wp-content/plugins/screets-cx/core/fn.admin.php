 ...
 * @return void
 */
function cx_api( $c = null, $force = false ) {
	$lc = get_option( 'cx_c9f1a6384b1c466d4612f513bd8e13ea' );
	$lce = get_option( 'cx_error' );

	if( defined( base64_decode( 'Q1hfQUNUSVZBVEVfSw==' ) ) && !$force ) {

		if( empty( $lc ) ) {
			update_option( 'cx_c9f1a6384b1c466d4612f513bd8e13ea', base64_decode( 'QWN0aXZlIGxpY2Vuc2U=' ) . ': ' . CX_ACTIVATE_T . '<small style="display:block;max-width:500px;color:#999" class="description">'.base64_decode('QXV0by11cGRhdGVzIG5vdCBzdXBwb3J0ZWQuIFBsZWFzZSBrZWVwIHlvdXIgdGhlbWUgdXAtdG8tZGF0ZS4gSWYgeW91IHdhbnQsIHlvdSBjYW4gcHVyY2hhc2UgYSBDWCBsaWNlbnNlIHRvIGdldCBhdXRvLXVwZGF0ZXMgYW5kIGZyZWUgc3VwcG9ydCBmcm9tIFNjcmVldHMu').'.</small>' );
	...
	if( function_exists( 'curl_init' ) ) {
		...
		elseif( !empty( $r[0] ) ) { 
			...
			// Catch error
			update_option( 'cx_error', base64_decode( '' ) . '<p><small><strong>ERROR MESSAGE:</strong> ' . print_r( $data,1) . '</small></p>' );
		}

	
	} else {
		update_option( 'cx_error', base64_decode( '' ) );
	}
