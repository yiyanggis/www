                            ...
                            <ul class="qfb-cf">
                                ...
                                <?php if (count($allForms)) : ?>
                                    <?php foreach ($allForms as $allForm) : ?>
                                        <li class="qfb-cf"><a title="<?php echo esc_attr($allForm['name']); ?>" href="admin.php?page=iphorm_entries&amp;id=<?php echo $allForm['id']; ?>"><?php echo esc_html($allForm['name']); ?><span class="ifb-fade-overflow"></span></a></li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
                        </div>
