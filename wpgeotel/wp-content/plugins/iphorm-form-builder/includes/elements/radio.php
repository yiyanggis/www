            ...
            <?php
                ...
                <div class="iphorm-input-li iphorm-input-radio-li <?php echo $name; ?>-input-li" <?php echo $element->getCss('optionLi'); ?>>
                    <label <?php echo $element->getCss('optionLabel'); ?> class="<?php echo $name . '_' . $i . '_label'; ?>">
                        <input class="iphorm-element-radio <?php echo $name; ?> <?php echo $name . '_' . $i; ?>" type="radio" name="<?php echo $name; ?>" id="<?php echo $uniqueId . "_$i"; ?>" value="<?php echo _wp_specialchars($option['value'], ENT_COMPAT, false, true); ?>" <?php echo (in_array($option['value'], $value)) ? 'checked="checked"' : ''; ?> />
