...
function iphorm_enqueue_styles()
{
    ...
    if (!get_option('iphorm_disable_qtip_output')) {
        wp_enqueue_style('qtip', IPHORM_PLUGIN_URL . '/js/qtip2/jquery.qtip.min.css', array(), '2.0.1');
    }
...
function iphorm_enqueue_scripts()
{
    ...
    if (!get_option('iphorm_disable_qtip_output')) {
        wp_enqueue_script('qtip', IPHORM_PLUGIN_URL . '/js/qtip2/jquery.qtip.min.js', array('jquery'), '2.0.1', true);
    }
    ...
    if (!get_option('iphorm_disable_uniform_output') && (is_array($activeUniformThemes) && count($activeUniformThemes))) {
        wp_enqueue_script('uniform', IPHORM_PLUGIN_URL . '/js/uniform/jquery.uniform.min.js', array('jquery'), '2.1.0', true);
    }
